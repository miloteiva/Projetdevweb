...
// ─────────────────────────────────────────────────────────
// MODE LIBRE : avis général (pas lié à une commande)
// ─────────────────────────────────────────────────────────
if ($orderId === 0) {
    if (!isset($data['avis'])) $data['avis'] = [];
    if (!isset($data['id_counters']['avis'])) $data['id_counters']['avis'] = 0;
    $data['id_counters']['avis']++;

    $data['avis'][] = [
        'id'          => $data['id_counters']['avis'],
...
// ─────────────────────────────────────────────────────────
// MODE COMMANDE : avis lié à une commande livrée précise
// ─────────────────────────────────────────────────────────
$found = false;
